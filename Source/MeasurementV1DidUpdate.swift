...
public struct MeasurementV1DidUpdate: MeasurementV1Notification {

    public typealias Args = MeasurementV1<Double>

    // MARK: - Properties
    public var type : MeasurementV1NotificationType { return .didUpdate }
